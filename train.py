...
if __name__ == '__main__':
    ...
    trainer = Trainer(
        devices=1, accelerator="gpu", reload_dataloaders_every_n_epochs=1, default_root_dir="./checkpoints/", 
        logger=wandb_logger, callbacks=[GrowImprovementPerEpochLogger(seed=seed, target=target)]
    )
